...
class Jobs:
    ...
    def create_job(job_id, job_title, salary, experience, education, date_posted, job_org, location, image_url,
        ...
        conn = get_db_connection()
        cursor = conn.cursor(dictionary=True)
        cursor.execute("INSERT INTO jobs (job_id, job_title, salary, experience, education, date_posted, job_org, location, image_url, job_description, sector) VALUE(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", 
                       (job_id, job_title, salary, experience, education, date_posted, job_org, location, image_url, job_description, sector))
        conn.commit()
        cursor.close()
        conn.close()
